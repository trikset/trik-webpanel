...
const app = new Vue({
    ...
    created: function () {
        ...
        this.m3 = ports[25];
        this.m4 = ports[26];
        this.video1Edge = ports[27];
        this.video2Edge = ports[28];
        this.usbCameraEdge = ports[29];
        this.gyroscope = ag[3];
    ...
    methods: {
        ...
        defaultPorts() {
            ...
            this.m3 = "motor100";
            this.m4 = "motor100";
            this.video1Edge = "false";
            this.video2Edge = "false";
            this.usbCameraEdge = "false";
            this.e1State = "false";
            this.e2State = "true";
            this.e3State = "false";
            this.e4State = "true";
