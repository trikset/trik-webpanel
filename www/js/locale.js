...
window.translations = {
    'ru': {
        ...
        'confirmDeleteImages': 'Вы действительно хотите удалить все изображения?',
        ...
        'downloadIsGoing': 'Подождите, загрузка начинается',
        'en': 'Англ',
        'enable': 'Включить',
        'enabled': 'включен',
        'encoders': 'Энкодеры',
    ...
    'en': {
        ...
        'confirm': 'Confirm',
        'confirmDeleteImages': 'Do you really want to delete all images?',
        'confirmDownloadImages': 'Download all images?',
        ...
        'createScreenshot': 'Make screenshot',
        ...
        'downloadIsGoing': 'Wait, download starts',
        'en': 'En',
        'enable': 'Enable',
        'enabled': 'enabled',
        'encoders': 'Encoders',
